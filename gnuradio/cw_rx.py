...
class cw_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "cw_rx")
        ...
        self.freq = freq = 437175000
        self.bandwidth = bandwidth = samp_rate/(2*decimation)
        ...
        self.freq_xlating_fft_filter_ccc_0 = filter.freq_xlating_fft_filter_ccc(1, firdes.complex_band_pass(1, samp_rate, -samp_rate/(2*decimation), samp_rate/(2*decimation), transition_bw), 10000, samp_rate)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_bandwidth(self.samp_rate/(2*self.decimation))
        self.freq_xlating_fft_filter_ccc_0.set_taps(firdes.complex_band_pass(1, self.samp_rate, -self.samp_rate/(2*self.decimation), self.samp_rate/(2*self.decimation), self.transition_bw))
